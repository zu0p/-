<template>
  <v-card>
    ...
    <v-img height="200" src="../../images/draw.png">
      <v-row align="center" justify="center" class="mt-3">
        <v-col class="text-center">
          ...
          <v-btn class="mx-2 profile-image-update" fab small dark color="light blue" @click="profileUpdateClick">
            <v-icon>
              mdi-image-plus
            </v-icon>
          </v-btn>
        ...
        <v-row justify="center">
          <v-col cols="9">
            <v-row align="center" justify="center">
              ...
              <v-col cols="4"> </v-col>
              <v-col cols="2">
                <v-btn v-if="!isUpdate" fab small text @click="isUpdate = !isUpdate">
                  <v-icon dark>
                    mdi-pencil
                  </v-icon>
                </v-btn>
                <v-menu v-if="isUpdate" bottom left transition="slide-y-transition">
    ...
    <v-card-actions v-if="!isPwdUpdate">
      <v-spacer></v-spacer>
      <v-btn v-if="isUpdate" color="blue" depressed dark @click="updateClick">
        <v-icon left>
          mdi-update
        </v-icon>
        Update
      </v-btn>
      <v-btn v-if="isUpdate" color="blue-grey lighten-1" depressed dark @click="isUpdate = false">
        <v-icon left>
          mdi-close-thick
        </v-icon>
        cancel
      </v-btn>
      <v-btn v-else color="blue-grey lighten-1" depressed dark @click="closeClick">
        <v-icon left>
          mdi-close-thick
        </v-icon>
        Close
    ...
    <v-card-actions v-if="isPwdUpdate">
      <v-spacer></v-spacer>
      <v-btn color="green" depressed dark @click="pwdChangeClick">
        <v-icon left>
          mdi-update
        </v-icon>
        Change
      </v-btn>
      <v-btn color="blue-grey lighten-1" depressed dark @click="closeClick">
        <v-icon left>
          mdi-close-thick
        </v-icon>
        close
